...
import (
	...
	"github.com/argoproj/argo-rollouts/utils/security"
...
type Provider interface {
	...
	Verify(tokenString string, argoSettings *settings.ArgoRolloutsSettings) (*gooidc.IDToken, error)
}
...
func (p *providerImpl) Verify(tokenString string, argoSettings *settings.ArgoRolloutsSettings) (*gooidc.IDToken, error) {
