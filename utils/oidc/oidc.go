...
type ClientApp struct {
	...
	settings *settings.ArgoRolloutsSettings
...
func NewClientApp(settings *settings.ArgoRolloutsSettings, dexServerAddr string, dexTlsConfig *dex.DexTLSConfig, baseHRef string, cacheClient cache.CacheClient) (*ClientApp, error) {
...
func formatUserInfoResponseCacheKey(pub string, sub string) string {
	return fmt.Sprintf("%s_%s", pub, sub)
}
