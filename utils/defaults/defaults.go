...
const (
	...
	// DefaultAnalysisRunSuccessfulHistoryLimit default number of succeed AnalysisRuns to keep if .Spec.Analysis.SuccessfulRunHistoryLimit is nil
	DefaultAnalysisRunSuccessfulHistoryLimit = int32(1)
