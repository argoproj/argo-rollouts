...
type PodFailurePolicy struct {
	...
	// +listType=atomic
	Rules                []PodFailurePolicyRule `protobuf:"bytes,1,rep,name=rules" json:"rules"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
type PodFailurePolicyOnExitCodesRequirement struct {
	...
	Operator PodFailurePolicyOnExitCodesOperator `protobuf:"bytes,2,opt,name=operator,casttype=PodFailurePolicyOnExitCodesOperator" json:"operator"`
...
type PodFailurePolicyOnPodConditionsPattern struct {
	...
	Type k8s_io_api_core_v1.PodConditionType `protobuf:"bytes,1,opt,name=type,casttype=k8s.io/api/core/v1.PodConditionType" json:"type"`
...
type PodFailurePolicyRule struct {
	...
	Action PodFailurePolicyAction `protobuf:"bytes,1,opt,name=action,casttype=PodFailurePolicyAction" json:"action"`
	...
	// +listType=atomic
	OnPodConditions      []PodFailurePolicyOnPodConditionsPattern `protobuf:"bytes,3,rep,name=onPodConditions" json:"onPodConditions"`
	XXX_NoUnkeyedLiteral struct{}                                 `json:"-"`
	XXX_sizecache        int32                                    `json:"-"`
}
