...
// ClearWeightUpdateDeadline provides a mock function with no fields
func (_m *TrafficRoutingReconciler) ClearWeightUpdateDeadline() error {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for ClearWeightUpdateDeadline")
	}
...
// GetWeightUpdateDeadline provides a mock function with no fields
func (_m *TrafficRoutingReconciler) GetWeightUpdateDeadline() (*time.Time, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetWeightUpdateDeadline")
	}
