...
<a name="v1.10.0"></a>
## [v1.10.0](https://github.com/argoproj/argo-rollouts/compare/v1.10.0-rc1...v1.10.0) (2026-08-05)

### Fix

* guard empty Values in injected anti-affinity check (cherry-pick [#4832](https://github.com/argoproj/argo-rollouts/issues/4832) for 1.10) ([#4917](https://github.com/argoproj/argo-rollouts/issues/4917))
* uprade pnpm for sbom (cherry-pick [#4821](https://github.com/argoproj/argo-rollouts/issues/4821) for 1.10) ([#4830](https://github.com/argoproj/argo-rollouts/issues/4830))
* **controller:** skip unnecessary ephemeral metadata pod listing (cherry-pick [#4951](https://github.com/argoproj/argo-rollouts/issues/4951) for 1.10) ([#4952](https://github.com/argoproj/argo-rollouts/issues/4952))
* **controller:** sync desired-replicas annotation during abort scale-… ([#4919](https://github.com/argoproj/argo-rollouts/issues/4919))
* **controller:** log the underlying error when newRolloutContext returns nil (cherry-pick [#4850](https://github.com/argoproj/argo-rollouts/issues/4850) for 1.10) ([#4906](https://github.com/argoproj/argo-rollouts/issues/4906))
* **controller:** select namespace-support notification controller via self-service flag (cherry-pick [#4851](https://github.com/argoproj/argo-rollouts/issues/4851) for 1.10) ([#4866](https://github.com/argoproj/argo-rollouts/issues/4866))
* **controller:** Downgrade log level for unconfigured notification triggers. Fixes [#3459](https://github.com/argoproj/argo-rollouts/issues/3459) (cherry-pick [#4833](https://github.com/argoproj/argo-rollouts/issues/4833) for 1.10) ([#4849](https://github.com/argoproj/argo-rollouts/issues/4849))
* **controller:** prevent panic when notifications write Unstructured … (cherry-pick [#4844](https://github.com/argoproj/argo-rollouts/issues/4844) for 1.10) ([#4846](https://github.com/argoproj/argo-rollouts/issues/4846))
* **controller:** deepcopy ALB status updates. Fixes [#3673](https://github.com/argoproj/argo-rollouts/issues/3673), [#4184](https://github.com/argoproj/argo-rollouts/issues/4184) (cherry-pick [#4780](https://github.com/argoproj/argo-rollouts/issues/4780) for 1.10) ([#4916](https://github.com/argoproj/argo-rollouts/issues/4916))
* **experiments:** add API fallback when ReplicaSet lister is stale on AlreadyExists ([#4842](https://github.com/argoproj/argo-rollouts/issues/4842)) (cherry-pick [#4855](https://github.com/argoproj/argo-rollouts/issues/4855) for 1.10) ([#4870](https://github.com/argoproj/argo-rollouts/issues/4870))

### Test

* fixed flaky test close channel (cherry-pick [#4908](https://github.com/argoproj/argo-rollouts/issues/4908) for 1.10) ([#4909](https://github.com/argoproj/argo-rollouts/issues/4909))
* fix flaky unit test TestListWithWatch (cherry-pick [#4905](https://github.com/argoproj/argo-rollouts/issues/4905) for 1.10) ([#4907](https://github.com/argoproj/argo-rollouts/issues/4907))


<a name="v1.10.0-rc1"></a>
## [v1.10.0-rc1](https://github.com/argoproj/argo-rollouts/compare/v1.9.1...v1.10.0-rc1) (2026-06-30)

### Build

* skip full CI for documentation only changes ([#4737](https://github.com/argoproj/argo-rollouts/issues/4737))
* Parameterized build system for company forks ([#4605](https://github.com/argoproj/argo-rollouts/issues/4605))
* Stop rendering gh-pages ([#4583](https://github.com/argoproj/argo-rollouts/issues/4583))

### Chore

* Address CVE-2026-35469 ([#4814](https://github.com/argoproj/argo-rollouts/issues/4814))
* switch to *bool for clusterScope ([#4551](https://github.com/argoproj/argo-rollouts/issues/4551))
* update notification engine ([#4715](https://github.com/argoproj/argo-rollouts/issues/4715))
* don't use httpbin.org it's flaky ([#4554](https://github.com/argoproj/argo-rollouts/issues/4554))
* add OneSignal to USERS.md ([#4765](https://github.com/argoproj/argo-rollouts/issues/4765))
* add Code owners similar to Argo CD ([#4628](https://github.com/argoproj/argo-rollouts/issues/4628))
* Migrate to pnpm ([#4699](https://github.com/argoproj/argo-rollouts/issues/4699)) ([#4712](https://github.com/argoproj/argo-rollouts/issues/4712))
* update `expr` version from `v1.16.9` to `v1.17.7` ([#4588](https://github.com/argoproj/argo-rollouts/issues/4588))
* update USERS.md to remove duplicates and fix numbering ([#4620](https://github.com/argoproj/argo-rollouts/issues/4620))
* support team workflows and Nats.io for notifications ([#4625](https://github.com/argoproj/argo-rollouts/issues/4625))
* **deps:** bump actions/cache from 4 to 5 ([#4622](https://github.com/argoproj/argo-rollouts/issues/4622))
* **deps:** bump golang to 1.26 ([#4638](https://github.com/argoproj/argo-rollouts/issues/4638))
* **deps:** update debian11 to debian12 ([#4652](https://github.com/argoproj/argo-rollouts/issues/4652))
* **deps:** bump actions/upload-artifact from 5 to 6 ([#4601](https://github.com/argoproj/argo-rollouts/issues/4601))
* **deps:** update dependencies to latest ([#4659](https://github.com/argoproj/argo-rollouts/issues/4659))
* **deps:** bump actions/setup-go from 6.0.0 to 6.1.0 ([#4549](https://github.com/argoproj/argo-rollouts/issues/4549))
* **deps:** update google.golang.org/grpc. Fixes [#4667](https://github.com/argoproj/argo-rollouts/issues/4667) ([#4686](https://github.com/argoproj/argo-rollouts/issues/4686))
* **deps:** bump actions/checkout from 5 to 6 ([#4550](https://github.com/argoproj/argo-rollouts/issues/4550))
* **deps:** migrate to go.yaml.in/yaml/v2 ([#4683](https://github.com/argoproj/argo-rollouts/issues/4683))
* **deps:** update dependencies for cves ([#4801](https://github.com/argoproj/argo-rollouts/issues/4801))
* **deps:** bump softprops/action-gh-release from 2.4.1 to 2.4.2 ([#4530](https://github.com/argoproj/argo-rollouts/issues/4530))
* **deps:** bump docker/setup-qemu-action from 3.6.0 to 3.7.0 ([#4525](https://github.com/argoproj/argo-rollouts/issues/4525))

### Ci

* skip checks for documentation PR ([#4816](https://github.com/argoproj/argo-rollouts/issues/4816))
* Bring Cherry pick functionality from Argo CD ([#4797](https://github.com/argoproj/argo-rollouts/issues/4797))
* Speedup test timing with effective caching part 2 ([#4714](https://github.com/argoproj/argo-rollouts/issues/4714))
* upload unit and e2e coverage separately with Codecov flags ([#4761](https://github.com/argoproj/argo-rollouts/issues/4761))
* Speedup Go build timing with effective caching ([#4702](https://github.com/argoproj/argo-rollouts/issues/4702))
* pin pr-check version ([#4685](https://github.com/argoproj/argo-rollouts/issues/4685))
* Speed up ci by ignoring codeql for docs only change ([#4641](https://github.com/argoproj/argo-rollouts/issues/4641))
* pin k3s version to avoid breakage of e2e tests ([#4644](https://github.com/argoproj/argo-rollouts/issues/4644))
* test e2e against k8s 1.35 ([#4636](https://github.com/argoproj/argo-rollouts/issues/4636))
* Llm disclosure ([#4627](https://github.com/argoproj/argo-rollouts/issues/4627))

### Docs

* Added roadmap (again) ([#4811](https://github.com/argoproj/argo-rollouts/issues/4811))
* minor spelling mistakes ([#4781](https://github.com/argoproj/argo-rollouts/issues/4781))
* explain how to run the UI locally from source ([#4773](https://github.com/argoproj/argo-rollouts/issues/4773))
* explain policy for plugins ([#4738](https://github.com/argoproj/argo-rollouts/issues/4738))
* fix broken Anti Affinity link on canary/bluegreen pages ([#4700](https://github.com/argoproj/argo-rollouts/issues/4700))
* clarify header based routing via plugins ([#4708](https://github.com/argoproj/argo-rollouts/issues/4708))
* add missing argoproj-labs plugins to metric and traffic-router lists ([#4705](https://github.com/argoproj/argo-rollouts/issues/4705))
* Updated workflows readme ([#4640](https://github.com/argoproj/argo-rollouts/issues/4640))
* add rollout secret change best practice ([#4189](https://github.com/argoproj/argo-rollouts/issues/4189))
* update rollout spec for incorrect attribute YAML ([#4633](https://github.com/argoproj/argo-rollouts/issues/4633))
* clarify basic canary options applicability. Fixes [#1821](https://github.com/argoproj/argo-rollouts/issues/1821) ([#4649](https://github.com/argoproj/argo-rollouts/issues/4649))
* Update Changelog ([#4529](https://github.com/argoproj/argo-rollouts/issues/4529))
* Add 'Netease Cloud Music' to USERS.md ([#4594](https://github.com/argoproj/argo-rollouts/issues/4594))
* mention managedFieldsManagers option of Argo CD for GitOps scenarios ([#4586](https://github.com/argoproj/argo-rollouts/issues/4586))
* clarify the v1alpha meaning for Rollouts ([#4587](https://github.com/argoproj/argo-rollouts/issues/4587))
* Add Procore to the list of users ([#4577](https://github.com/argoproj/argo-rollouts/issues/4577))
* **cli:** add mise alternative installation for kubectl plugin ([#4532](https://github.com/argoproj/argo-rollouts/issues/4532))
* **controller:** Resource Plugin Proposal ([#4387](https://github.com/argoproj/argo-rollouts/issues/4387))
* **example:** Update argo-rollouts docs url ([#4599](https://github.com/argoproj/argo-rollouts/issues/4599))

### Feat

* **metricprovider:** make Datadog API request timeout configurable ([#4812](https://github.com/argoproj/argo-rollouts/issues/4812))

### Feat!

* update default Traefik API group to v3 ([#4572](https://github.com/argoproj/argo-rollouts/issues/4572))

### Fix

* allow plugins to implement ping-pong (and not just ALB/Istio) ([#4740](https://github.com/argoproj/argo-rollouts/issues/4740))
* bluegreen analysis prematurely succeeds if new ReplicaSet becomes unsaturated ([#4604](https://github.com/argoproj/argo-rollouts/issues/4604))
* update broken yarn.lock file ([#4603](https://github.com/argoproj/argo-rollouts/issues/4603))
* job with image pull error should not be marked as successful ([#4602](https://github.com/argoproj/argo-rollouts/issues/4602))
* preserve CRD field descriptions for kubectl explain ([#4687](https://github.com/argoproj/argo-rollouts/issues/4687))
* create isolated logger for redactor ([#4703](https://github.com/argoproj/argo-rollouts/issues/4703))
* remove header & mirror routes so rollout can complete. Fixes [#2526](https://github.com/argoproj/argo-rollouts/issues/2526) ([#4307](https://github.com/argoproj/argo-rollouts/issues/4307))
* remove readinessProbe on rollout install ([#4704](https://github.com/argoproj/argo-rollouts/issues/4704))
* allows plugins to implement traffic mirroring (and not just Istio) ([#4643](https://github.com/argoproj/argo-rollouts/issues/4643))
* Typo in VPA deployment description ([#4669](https://github.com/argoproj/argo-rollouts/issues/4669))
* leader lease name from instance id ([#4768](https://github.com/argoproj/argo-rollouts/issues/4768))
* incorrect evaluation of scale down delay on rollback ([#4787](https://github.com/argoproj/argo-rollouts/issues/4787))
* **analysis:** detect infrastructure errors early and mark job analysis as inconclusive ([#4692](https://github.com/argoproj/argo-rollouts/issues/4692))
* **analysis:** improve error messages for AnalysisRun metric evaluation failures. Fixes [#2101](https://github.com/argoproj/argo-rollouts/issues/2101) ([#4680](https://github.com/argoproj/argo-rollouts/issues/4680))
* **controller:** Use maxTrafficWeight instead of hardcoded 100 in checkReplicasAvailable. ([#4646](https://github.com/argoproj/argo-rollouts/issues/4646))
* **controller:** Always reconcile pod metadata ([#4477](https://github.com/argoproj/argo-rollouts/issues/4477))
* **controller:** Exit reconciliation early after in-flight Rollout writes ([#4784](https://github.com/argoproj/argo-rollouts/issues/4784))
* **controller:** Skip analysis runs if no templates are specified ([#4544](https://github.com/argoproj/argo-rollouts/issues/4544))
* **controller:** Cap minPodsPerReplicaSet to rollout spec replicas. Fixes [#4566](https://github.com/argoproj/argo-rollouts/issues/4566) ([#4570](https://github.com/argoproj/argo-rollouts/issues/4570))
* **controller:** ensure progress when canary > desired replicas ([#4619](https://github.com/argoproj/argo-rollouts/issues/4619))
* **controller:** honor stderrthreshold when logtostderr is enabled ([#4673](https://github.com/argoproj/argo-rollouts/issues/4673))
* **controller:** Requeue on stale informer cache instead of writeBackToInformer ([#4786](https://github.com/argoproj/argo-rollouts/issues/4786))
* **controller:** reduce memory by filtering ReplicaSet informer ([#4666](https://github.com/argoproj/argo-rollouts/issues/4666))
* **controller:** convert unstructured→typed to avoid memory bloat ([#4745](https://github.com/argoproj/argo-rollouts/issues/4745))
* **dashboard:** Show page size selector in table view ([#4629](https://github.com/argoproj/argo-rollouts/issues/4629))
* **dashboard:** avoid dialing 0.0.0.0 in newHTTPServer. Fixes [#3931](https://github.com/argoproj/argo-rollouts/issues/3931). ([#4589](https://github.com/argoproj/argo-rollouts/issues/4589))
* **dashboard:** guard null chartValue in metric chart tooltip. Fixes [#4743](https://github.com/argoproj/argo-rollouts/issues/4743) ([#4744](https://github.com/argoproj/argo-rollouts/issues/4744))
* **dashboard:** View full image URI while editing ([#4573](https://github.com/argoproj/argo-rollouts/issues/4573))
* **experiments:** fall back to API when AnalysisRun missing from informer cache. Fixes [#4804](https://github.com/argoproj/argo-rollouts/issues/4804) ([#4805](https://github.com/argoproj/argo-rollouts/issues/4805))
* **metricprovider:** Don't swallow RpcError returned by InitPlugin ([#4762](https://github.com/argoproj/argo-rollouts/issues/4762))
* **metricprovider:** Close HTTP response body ([#4720](https://github.com/argoproj/argo-rollouts/issues/4720))
* **trafficrouting:** cache RPC client to avoid 'Stdout already set' error. Fixes [#3918](https://github.com/argoproj/argo-rollouts/issues/3918) ([#4613](https://github.com/argoproj/argo-rollouts/issues/4613))
* **trafficrouting:** ReplicaSetReferenced does not check istio DestinationRules ([#4560](https://github.com/argoproj/argo-rollouts/issues/4560))
* **trafficrouting:** ensure DestinationRule is updated before SetWeight on rollback ([#4612](https://github.com/argoproj/argo-rollouts/issues/4612))
* **trafficrouting:** parse VirtualService name containing a period correctly ([#4766](https://github.com/argoproj/argo-rollouts/issues/4766))
* **trafficrouting:** set weight before hash for new canary ([#4564](https://github.com/argoproj/argo-rollouts/issues/4564))
* **trafficrouting:** ensure early SetWeight runs after checkReplicasAvailable ([#4639](https://github.com/argoproj/argo-rollouts/issues/4639))

### Refactor

* evaluate conditions after pause context is resolved ([#4785](https://github.com/argoproj/argo-rollouts/issues/4785))
* **deps:** replace pkg/errors with fmt.Errorf ([#4650](https://github.com/argoproj/argo-rollouts/issues/4650))
...
* use t.Log instead of fmt.Println ([#4735](https://github.com/argoproj/argo-rollouts/issues/4735))
* make tests resilient to nil ptr ([#4782](https://github.com/argoproj/argo-rollouts/issues/4782))


<a name="v1.9.1"></a>
## [v1.9.1](https://github.com/argoproj/argo-rollouts/compare/v1.9.0...v1.9.1) (2026-07-06)

### Chore

* Address CVE-2026-35469 (cherry-pick [#4814](https://github.com/argoproj/argo-rollouts/issues/4814) for 1.9) ([#4824](https://github.com/argoproj/argo-rollouts/issues/4824))
* **deps:** update google.golang.org/grpc. Fixes [#4667](https://github.com/argoproj/argo-rollouts/issues/4667) ([#4686](https://github.com/argoproj/argo-rollouts/issues/4686))
* **deps:** update google.golang.org/grpc. Fixes [#4667](https://github.com/argoproj/argo-rollouts/issues/4667) ([#4686](https://github.com/argoproj/argo-rollouts/issues/4686))

### Ci

* pin k3s version to avoid breakage of e2e tests ([#4644](https://github.com/argoproj/argo-rollouts/issues/4644)) ([#4820](https://github.com/argoproj/argo-rollouts/issues/4820))
...
<a name="v1.9.0"></a>
## [v1.9.0](https://github.com/argoproj/argo-rollouts/compare/v1.9.0-rc3...v1.9.0) (2026-03-19)
...
<a name="v1.9.0-rc1"></a>
## [v1.9.0-rc1](https://github.com/argoproj/argo-rollouts/compare/v1.8.4...v1.9.0-rc1) (2025-11-07)
...
<a name="v1.8.4"></a>
## [v1.8.4](https://github.com/argoproj/argo-rollouts/compare/v1.8.3...v1.8.4) (2026-01-30)

### Chore

* **deps:** bump github.com/hashicorp/go-plugin from 1.6.2 to 1.6.3 ([#4592](https://github.com/argoproj/argo-rollouts/issues/4592))
