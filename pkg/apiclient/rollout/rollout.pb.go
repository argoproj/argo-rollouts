...
type RolloutInfo struct {
	...
	// pauseDurationSeconds is the current canary pause step's duration, normalized to whole seconds by the
	// controller so clients never parse the duration grammar themselves. It is 0 when the rollout is not
	// paused on a step or the pause is indefinite, and -1 when the configured duration is not parseable.
	// Sub-second durations truncate toward zero (e.g. "500ms" is 0).
	PauseDurationSeconds int32 `protobuf:"varint,22,opt,name=pauseDurationSeconds,proto3" json:"pauseDurationSeconds,omitempty"`
	// pauseRemainingSeconds is how much of pauseDurationSeconds was left when this message was serialized.
	// It is a snapshot, not a fact about the resource: clients animate or print from it directly rather than
	// comparing timestamps, which keeps them correct even when the local clock is wrong. Invariant:
	// 0 <= pauseRemainingSeconds <= pauseDurationSeconds, and it is only meaningful when pauseDurationSeconds > 0.
	PauseRemainingSeconds int32    `protobuf:"varint,23,opt,name=pauseRemainingSeconds,proto3" json:"pauseRemainingSeconds,omitempty"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
	XXX_unrecognized      []byte   `json:"-"`
	XXX_sizecache         int32    `json:"-"`
}
...
func (m *RolloutInfo) GetPauseDurationSeconds() int32 {
	if m != nil {
		return m.PauseDurationSeconds
	}
	return 0
}

func (m *RolloutInfo) GetPauseRemainingSeconds() int32 {
	if m != nil {
		return m.PauseRemainingSeconds
	}
	return 0
}
...
var fileDescriptor_99101d942e8912a7 = []byte{
	...
	,
}
...
func (m *RolloutInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PauseRemainingSeconds != 0 {
		i = encodeVarintRollout(dAtA, i, uint64(m.PauseRemainingSeconds))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb8
	}
	if m.PauseDurationSeconds != 0 {
		i = encodeVarintRollout(dAtA, i, uint64(m.PauseDurationSeconds))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb0
...
func (m *RolloutInfo) Size() (n int) {
	...
	if m.PauseDurationSeconds != 0 {
		n += 2 + sovRollout(uint64(m.PauseDurationSeconds))
	}
	if m.PauseRemainingSeconds != 0 {
		n += 2 + sovRollout(uint64(m.PauseRemainingSeconds))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *RolloutInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PauseDurationSeconds", wireType)
			}
			m.PauseDurationSeconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowRollout
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PauseDurationSeconds |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 23:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PauseRemainingSeconds", wireType)
			}
			m.PauseRemainingSeconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowRollout
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PauseRemainingSeconds |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
