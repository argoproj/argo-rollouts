...
//	"github.com/argoproj/argo-rollouts/utils/rand"
//	oidcconfig "github.com/argoproj/argo-rollouts/utils/settings"
...
//)
//
//func NewCmdLogin(o *options.ArgoRolloutsOptions) *cobra.Command {
//  var (
//    ctxName          string
//		sso              bool
//		ssoPort          int
...
//		Use:          "login SERVER",
//		Short:        "Log in to Argo Rollout",
//		Long:         "Log in to Argo Rollout",
//		Example:      `# Login to Argo Rollout using SSO
//argocd login rollout.argoproj.io --sso
//
//# Configure direct access using Kubernetes API server
//argocd login rollout.argoproj.io --core`,
//		SilenceUsage: true,
...
//		},
//	}
//  cmd.Flags().BoolVar(&sso, "sso", false, "Perform SSO login")
//	cmd.Flags().IntVar(&ssoPort, "sso-port", common.DefaultSSOLocalPort, "Port to run local OAuth2 login application")
//	cmd.Flags().
...
//  cmd.Flags().BoolVar(&ssoLaunchBrowser, "sso-launch-browser", true, "Automatically launch the system default browser when performing SSO login")
//	return cmd
//}
//
