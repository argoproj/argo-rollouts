...
type TemplateServicePortMapping struct {
	// Port the service will respond to
	Port int32 `json:"port,omitempty" protobuf:"varint,1,opt,name=port"`
	// ContainerPort is the port on the pod that the service should send requests to
	ContainerPort int32 `json:"containerPort,omitempty" protobuf:"varint,2,opt,name=containerPort"`
}
