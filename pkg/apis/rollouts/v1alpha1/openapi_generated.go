...
func schema_pkg_apis_rollouts_v1alpha1_RolloutPluginStrategy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RolloutPluginStrategy defines the strategy for the rollout This is similar to RolloutStrategy but specific to RolloutPlugin",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
							Description: "Type of strategy (Canary or BlueGreen)",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"blueGreen": {
						SchemaProps: spec.SchemaProps{
							Description: "BlueGreen strategy configuration (reuses existing BlueGreenStrategy type)",
