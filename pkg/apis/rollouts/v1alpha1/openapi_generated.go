...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/argoproj/argo-rollouts/pkg/apis/rollouts/v1alpha1.TemplateServicePortMapping":                      schema_pkg_apis_rollouts_v1alpha1_TemplateServicePortMapping(ref),
...
func schema_pkg_apis_rollouts_v1alpha1_TemplateServicePortMapping(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"port": {
						SchemaProps: spec.SchemaProps{
							Description: "Port the service will respond to",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"containerPort": {
						SchemaProps: spec.SchemaProps{
							Description: "ContainerPort is the port on the pod that the service should send requests to",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
