...
func (in *CanaryStrategy) DeepCopyInto(out *CanaryStrategy) {
	*out = *in
	...
	if in.StableScaleDownPolicy != nil {
		in, out := &in.StableScaleDownPolicy, &out.StableScaleDownPolicy
		*out = new(StableScaleDownPolicy)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StableScaleDownPolicy) DeepCopyInto(out *StableScaleDownPolicy) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StableScaleDownPolicy.
func (in *StableScaleDownPolicy) DeepCopy() *StableScaleDownPolicy {
	if in == nil {
		return nil
	}
	out := new(StableScaleDownPolicy)
