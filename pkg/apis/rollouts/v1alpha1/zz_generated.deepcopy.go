...
func (in *ALBIngressWithPorts) DeepCopyInto(out *ALBIngressWithPorts) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ALBIngressWithPorts.
func (in *ALBIngressWithPorts) DeepCopy() *ALBIngressWithPorts {
	if in == nil {
		return nil
	}
	out := new(ALBIngressWithPorts)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ALBTrafficRouting) DeepCopyInto(out *ALBTrafficRouting) {
	*out = *in
	...
	if in.ServicePorts != nil {
		in, out := &in.ServicePorts, &out.ServicePorts
		*out = make([]ALBIngressWithPorts, len(*in))
		for i := range *in {
