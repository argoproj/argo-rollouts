...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedRoutes) DeepCopyInto(out *ManagedRoutes) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedRoutes.
func (in *ManagedRoutes) DeepCopy() *ManagedRoutes {
	if in == nil {
		return nil
	}
	out := new(ManagedRoutes)
	in.DeepCopyInto(out)
	return out
}
