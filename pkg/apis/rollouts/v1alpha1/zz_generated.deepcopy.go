...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AnalysisRunInfo) DeepCopyInto(out *AnalysisRunInfo) {
	*out = *in
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	if in.Jobs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AnalysisRunInfo.
func (in *AnalysisRunInfo) DeepCopy() *AnalysisRunInfo {
	if in == nil {
		return nil
	}
	out := new(AnalysisRunInfo)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExperimentInfo) DeepCopyInto(out *ExperimentInfo) {
	*out = *in
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	if in.ReplicaSets != nil {
		in, out := &in.ReplicaSets, &out.ReplicaSets
		*out = make([]ReplicaSetInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.AnalysisRuns != nil {
		...
		*out = make([]AnalysisRunInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExperimentInfo.
func (in *ExperimentInfo) DeepCopy() *ExperimentInfo {
	if in == nil {
		return nil
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicaSetInfo) DeepCopyInto(out *ReplicaSetInfo) {
	*out = *in
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	if in.Images != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicaSetInfo.
func (in *ReplicaSetInfo) DeepCopy() *ReplicaSetInfo {
	if in == nil {
		return nil
	}
	out := new(ReplicaSetInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RolloutInfo) DeepCopyInto(out *RolloutInfo) {
	*out = *in
	...
	if in.Experiments != nil {
		...
		*out = make([]ExperimentInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
