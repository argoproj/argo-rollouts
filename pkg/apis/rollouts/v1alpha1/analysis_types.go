...
type Metric struct {
	...
	// NotANumberValue allows users to define how NaN result is interpreted
	// Can set to Failure/Inconclusive/Successful
	// Default is Inconclusive
	// TODO: verify in validation
	NaNResult string `json:"nanResult,omitempty"`
}
