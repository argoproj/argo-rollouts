...
data:
  plugins: |-
    trafficrouters:
    - plugin: "argoproj-labs/sample-rollouts-trafficrouter-plugin" # name the plugin uses to find this configuration, it must match the name required by the plugin
