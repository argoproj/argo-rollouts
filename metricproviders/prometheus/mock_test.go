...
func (m *mockAPI) LabelValues(ctx context.Context, label string, matches []string, startTime time.Time, endTime time.Time, opt ...v1.Option) (model.LabelValues, v1.Warnings, error) {
	panic("Not used")
}
