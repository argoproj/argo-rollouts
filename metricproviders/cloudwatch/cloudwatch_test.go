...
func TestConvertType(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expected: []types.MetricDataQuery{
				{
					Id:         pointer.String("rate"),
					Expression: pointer.String("errors / requests"),
				},
				{
					Id: pointer.String("errors"),
					MetricStat: &types.MetricStat{
						Metric: &types.Metric{
							Namespace:  pointer.String("app"),
							MetricName: pointer.String("errors"),
						},
						Period: pointer.Int32(300),
						Stat:   pointer.String("Sum"),
						Unit:   types.StandardUnitCount,
					},
					ReturnData: pointer.Bool(false),
				},
				{
					Id: pointer.String("requests"),
					MetricStat: &types.MetricStat{
						Metric: &types.Metric{
							Namespace:  pointer.String("app"),
							MetricName: pointer.String("requests"),
						},
						Period: pointer.Int32(300),
						Stat:   pointer.String("Sum"),
						Unit:   types.StandardUnitCount,
					...
					MetricStat: &types.MetricStat{
						Metric: &types.Metric{
							...
							Dimensions: []types.Dimension{
								{
									Name:  pointer.String("hoge"),
									Value: pointer.String("fuga"),
								},
							},
						},
						Period: pointer.Int32(300),
						Stat:   pointer.String("Max"),
						Unit:   types.StandardUnitCount,
					},
					ReturnData: pointer.Bool(false),
				},
