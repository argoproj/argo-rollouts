...
func newCommand() *cobra.Command {
	...
	command.Flags().StringVar(&electOpts.LeaderElectionLeaseLockName, "leader-election-lease-lock-name", controller.DefaultLeaderElectionLeaseLockName, "The name of the lease lock that leader election will use. This is only applicable if leader election is enabled.")
